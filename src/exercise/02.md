...
```javascript
const props = {id: 'element-id', className: 'class-name'}
// createElement arguments are:
// (elementType as string, {props}, children comma separated)
// children can also be included in the props instead
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=catecodes%40gmail.com).
